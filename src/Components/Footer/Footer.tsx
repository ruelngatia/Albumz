...
export default function Footer() {
  return (
    <div data-testid='footer' className='flex flex-col md:flex-row justify-center space-y-2 md:space-x-24 bg-footerGrey text-center py-20'>
        <div>
            <h1 className='text-hoverPurple capitalize text-3xl font-bold cursor-default'>Albumz</h1>
        ...
        <div>
            <h1 className='text-hoverPurple capitalize text-3xl font-bold cursor-default'>Products</h1>
            <ul className="list-none mt-2 text-sm">
        ...
        <div>
            <h1 className='text-hoverPurple capitalize text-3xl font-bold cursor-default'>Follow us</h1>
            <ul className="list-none mt-2 text-sm">
